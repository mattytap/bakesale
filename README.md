...
The bakesale service uses the last 8 bits of the conntrack mark (0x000000ff).
...
To install the bakesale service via command line you can use the following:
...
wget "$repo/usr/lib/bakesale/create_pre_include.sh" -O "/usr/lib/bakesale/create_pre_include.sh"
wget "$repo/usr/lib/bakesale/create_post_include.sh" -O "/usr/lib/bakesale/create_post_include.sh"
wget "$repo/usr/lib/bakesale/create_post_include_user_set.sh" -O "/usr/lib/bakesale/create_post_include_user_set.sh"
wget "$repo/usr/lib/bakesale/create_post_include_rules.sh" -O "/usr/lib/bakesale/create_post_include_rules.sh"
chmod +x "/usr/lib/bakesale/common_helper.sh"
chmod +x "/usr/lib/bakesale/create_pre_include.sh"
chmod +x "/usr/lib/bakesale/create_post_include.sh"
chmod +x "/usr/lib/bakesale/create_post_include_user_set.sh"
chmod +x "/usr/lib/bakesale/create_post_include_rules.sh"
...
The user rules in '/etc/config/bakesale' use the same syntax as OpenWrt's firewall config, the 'class' option is used to specified the desired DSCP.

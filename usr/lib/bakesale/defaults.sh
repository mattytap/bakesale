...
# defaults.sh -- default configuration values for autorate.sh
#
# This file is part of autorate.
#
# AUTORATE IS HIGHLY CONFIGURABLE AND THIS FILE MAY BE 
# CONSULTED IN RESPECT OF OVERRIDING VARIABLES IN A CONFIG FILE.
#
# DO NOT MODIFY THIS FILE. ANY CHANGES NEED TO BE MADE TO
# THE CONFIG FILE FOR A GIVEN INSTANCE OF AUTORATE.
...
log_to_file=1              # enable (1) or disable (0) output logging to file (/tmp/autorate.log)
